...
const SCHOOL = "MyCollege";
console.log(SCHOOL); // error (this is becouse it is constant and constant cant change their value)
...
console.log(a) //appear
console.log(b) //it will not appear 
console.log("b is not defined outside block, it will make an error");
